...
| type 值 | 格式 | 说明 | 示例 |
|---------|------|------|------|
| `vision` | 图片匹配 | 通过截图/图片模板匹配定位 | `locator="vision:img/login_btn.png"` |
| `ocr` | 文字识别 | 通过 OCR 识别文字定位 | `locator="ocr:登录"` |
| `vision_bbox` | 坐标定位 | 直接使用坐标 `x1,y1,x2,y2` | `locator="vision_bbox:100,200,150,250"` |
